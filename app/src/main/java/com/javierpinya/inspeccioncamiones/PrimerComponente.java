...
@Entity(tableName = "PrimerComponente")
public class PrimerComponente {
    ...
    public PrimerComponente(String matricula, Date itv, Date adr, int tara, int pesoMaximo, int chip, String tipoComponente, Date fechaBaja, String codNacion, boolean soloGasoleo, boolean bloqueado, boolean queroseno) {
